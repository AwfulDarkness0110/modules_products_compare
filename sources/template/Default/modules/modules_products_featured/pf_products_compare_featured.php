 ...
 */
  ...
  class pf_products_compare_featured {
    public $code;
    public $group;
    public $title;
    public $description;
    ...
    public function __construct() {
      ...
      $this->title = CLICSHOPPING::getDef('module_products_compare_featured_title');
      $this->description = CLICSHOPPING::getDef('module_products_compare_featured_description');

      if (defined('MODULE_PRODUCTS_COMPARE_FEATURED_STATUS')) {
        $this->sort_order = MODULE_PRODUCTS_COMPARE_FEATURED_SORT_ORDER;
        $this->enabled = (MODULE_PRODUCTS_COMPARE_FEATURED_STATUS == 'True');
      }
    }
    ...
    public function execute() {
      ...
      if (isset($_GET['Products']) && isset($_GET['Featured'])) {
        if (MODULE_PRODUCTS_COMPARE_FEATURED_MAX_DISPLAY != 0 ) {

          $products_template = MODULE_PRODUCTS_COMPARE_FEATURED_TEMPLATE;

          $Qlisting = FeaturedClass::getListing();

          $Qlisting->setPageSet((int)MODULE_PRODUCTS_COMPARE_FEATURED_MAX_DISPLAY);
          $Qlisting->execute();
...
// display number of short description
            $products_short_description_number = (int)MODULE_PRODUCTS_COMPARE_FEATURED_SHORT_DESCRIPTION;
// delete words
            $delete_word = (int)MODULE_PRODUCTS_COMPARE_FEATURED_SHORT_DESCRIPTION_DELETE_WORLDS;
// nbr of column to display  boostrap
            $bootstrap_column = (int)MODULE_PRODUCTS_COMPARE_FEATURED_COLUMNS;
// initialisation des boutons
            $size_button = $CLICSHOPPING_ProductsCommon->getSizeButton('md');

// Template define
            $filename= '';
            $filename = $CLICSHOPPING_Template-> getTemplateModulesFilename($this->group .'/template_html/' . MODULE_PRODUCTS_COMPARE_FEATURED_TEMPLATE);
...
//Stock (good, alert, out of stock).
              $products_stock = $CLICSHOPPING_ProductsFunctionTemplate->getStock(MODULE_PRODUCTS_COMPARE_FEATURED_DISPLAY_STOCK, $products_id);
//Flash discount
...
// Display an input allowing for the customer to insert a quantity
              $input_quantity = $CLICSHOPPING_ProductsFunctionTemplate->getDisplayInputQuantity(MODULE_PRODUCTS_COMPARE_FEATURED_DELETE_BUY_BUTTON, $products_id);
...
// **************************
              ...
              if (MODULE_PRODUCTS_COMPARE_FEATURED_DELETE_BUY_BUTTON == 'False') {
...
// See the button more view details
               $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_PRODUCTS_COMPARE_FEATURED_DELETE_BUY_BUTTON, $products_id);
// Display the image
              $products_image = $CLICSHOPPING_ProductsFunctionTemplate->getImage(MODULE_PRODUCTS_COMPARE_FEATURED_IMAGE_MEDIUM, $products_id);
// Ticker Image
              $products_image .= $CLICSHOPPING_ProductsFunctionTemplate->getTicker(MODULE_PRODUCTS_COMPARE_FEATURED_TICKER, $products_id, 'ModulesProductsFeaturedBootstrapTickerSpecial', 'ModulesProductsFeaturedBootstrapTickerFavorite', 'ModulesProductsFeaturedBootstrapTickerFeatured', 'ModulesProductsFeaturedBootstrapTickerNew');

              $ticker = $CLICSHOPPING_ProductsFunctionTemplate->getTickerPourcentage(MODULE_PRODUCTS_COMPARE_FEATURED_POURCENTAGE_TICKER, $products_id, 'ModulesProductsFeaturedBootstrapTickerPourcentage');
...
// products_compare
    ...
    public function check() {
      return defined('MODULE_PRODUCTS_COMPARE_FEATURED_STATUS');
    }
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_COMPARE_FEATURED_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_COMPARE_FEATURED_TEMPLATE',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_COMPARE_FEATURED_MAX_DISPLAY',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_COMPARE_FEATURED_COLUMNS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_COMPARE_FEATURED_SHORT_DESCRIPTION',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_COMPARE_FEATURED_SHORT_DESCRIPTION_DELETE_WORLDS',
          'configuration_value' => '0',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_COMPARE_FEATURED_TICKER',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_COMPARE_FEATURED_POURCENTAGE_TICKER',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_COMPARE_FEATURED_DISPLAY_STOCK',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_COMPARE_FEATURED_IMAGE_MEDIUM',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_COMPARE_FEATURED_DELETE_BUY_BUTTON',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_COMPARE_FEATURED_SORT_ORDER',
    ...
    public function keys() {
      return array (
        'MODULE_PRODUCTS_COMPARE_FEATURED_STATUS',
        'MODULE_PRODUCTS_COMPARE_FEATURED_TEMPLATE',
        'MODULE_PRODUCTS_COMPARE_FEATURED_MAX_DISPLAY',
        'MODULE_PRODUCTS_COMPARE_FEATURED_COLUMNS',
        'MODULE_PRODUCTS_COMPARE_FEATURED_SHORT_DESCRIPTION',
        'MODULE_PRODUCTS_COMPARE_FEATURED_SHORT_DESCRIPTION_DELETE_WORLDS',
        'MODULE_PRODUCTS_COMPARE_FEATURED_TICKER',
        'MODULE_PRODUCTS_COMPARE_FEATURED_POURCENTAGE_TICKER',
        'MODULE_PRODUCTS_COMPARE_FEATURED_DISPLAY_STOCK',
        ...
        'MODULE_PRODUCTS_COMPARE_FEATURED_IMAGE_MEDIUM',
        'MODULE_PRODUCTS_COMPARE_FEATURED_DELETE_BUY_BUTTON',
        'MODULE_PRODUCTS_COMPARE_FEATURED_SORT_ORDER'
      );
    }
  }
