 ...
 */
  ...
  class ps_products_specials_compare {
    public $code;
    public $group;
    public $title;
    public $description;
    ...
    public function __construct() {
      ...
      $this->title = CLICSHOPPING::getDef('module_products_specials_compare_title');
      $this->description = CLICSHOPPING::getDef('module_products_specials_compare_description');

      if (defined('MODULE_PRODUCTS_SPECIAL_COMPARE_STATUS')) {
        $this->sort_order = MODULE_PRODUCTS_SPECIAL_COMPARE_SORT_ORDER;
        $this->enabled = (MODULE_PRODUCTS_SPECIAL_COMPARE_STATUS == 'True');
      }
    }
    ...
    public function execute() {
      ...
      if (isset($_GET['Products']) && isset($_GET['Specials'])) {
        if (MODULE_PRODUCTS_SPECIAL_COMPARE_MAX_DISPLAY != 0 ) {
          $Qlisting = SpecialsClass::getListing();

          $Qlisting->setPageSet((int)MODULE_PRODUCTS_SPECIAL_COMPARE_MAX_DISPLAY);
          $Qlisting->execute();

          $listingTotalRow = $Qlisting->getPageSetTotalRows();

          $new_compare_prods_content = '<!-- Specials Products start -->' . "\n";
          $new_compare_prods_content .= '<div class="clearfix"></div>';
          $new_compare_prods_content .= '<div class="contentText">';
          $new_compare_prods_content .= '<div class="ModulesProductsSpecialsContainer">';

          if ($listingTotalRow > 0) {

            $new_compare_prods_content .= '<div class="col-md-5 float-start">';
            $new_compare_prods_content .= '<div class="page-header ModulesProductsSpecialsHeadingTitle">';
            $new_compare_prods_content .= '<h1>' . CLICSHOPPING::getDef('text_heading_title') .'</h1>';
            $new_compare_prods_content .= '</div>';
            $new_compare_prods_content .= '</div>';

            $new_compare_prods_content .= '<div class="col-md-5 float-end">';
            $new_compare_prods_content .= '<div style="padding-right:2em; padding-top:0.5rem;">';
            $new_compare_prods_content .= '<div class="dropdown">';
            $new_compare_prods_content .= '<div class="btn-group btn-group-sm float-end">';
            $new_compare_prods_content .= '<button type="button" class="btn btn-secondary dropdown-toggle"  data-toggle="dropdown" id="dropdownMenu2" aria-haspopup="true" aria-expanded="false">';
            $new_compare_prods_content .= CLICSHOPPING::getDef('text_sort_by');
            $new_compare_prods_content .= '</button>';
            $new_compare_prods_content .= '<ul class="dropdown-menu text-start"  aria-labelledby="dropdownMenu2">';
...
// number of sort criterias
            ...
            for ($col = 0, $n = count($column_list); $col < $n; $col++) {
              ...
              $new_compare_prods_content .= '<li>' . $lc_text . '</li>';
            }

            $new_compare_prods_content .= '</ul>';
            $new_compare_prods_content .= '</div>';
            $new_compare_prods_content .= '</div>';
...
/*
            if ((defined('MODULE_HEADER_TAGS_GRID_LIST_VIEW_STATUS') && MODULE_HEADER_TAGS_GRID_LIST_VIEW_STATUS == 'True') && (strpos(MODULE_HEADER_TAGS_GRID_LIST_VIEW_PAGES, CLICSHOPPING::getBaseNameIndex() !== false))) {
              ...
              $new_compare_prods_content .= '<strong>' . CLICSHOPPING::getDef('text_view') . '</strong>';
              $new_compare_prods_content .= '<div class="btn-group">';
              $new_compare_prods_content .= '<a href="' . $link . '" id="list" class="btn btn-default btn-sm"><span class="fa fa-th-list"></span>' . CLICSHOPPING::getDef('text_view_list') . '</a>';
              $new_compare_prods_content .= '<a href="' . $link . '" id="grid" class="btn btn-default btn-sm"><span class="fa fa-th"></span>' . CLICSHOPPING::getDef('text_view_grid') . '</a>';
              $new_compare_prods_content .= '</div>';
            }
*/
            $new_compare_prods_content .= '</div>';
          ...
          if (($listingTotalRow > 0) && ((PREV_NEXT_BAR_LOCATION == '1') || (PREV_NEXT_BAR_LOCATION == '3'))) {
            if ((PREV_NEXT_BAR_LOCATION == '1') || (PREV_NEXT_BAR_LOCATION == '3')) {
              $new_compare_prods_content .= '<div class="clearfix"></div>';
              $new_compare_prods_content .= '<div>';
              $new_compare_prods_content .= '<div class="col-md-6 pagenumber hidden-xs">';
              $new_compare_prods_content .=  $Qlisting->getPageSetLabel(CLICSHOPPING::getDef('text_display_number_of_items'));
              $new_compare_prods_content .= '</div>';
              $new_compare_prods_content .= '<div class="col-md-6 float-end">';
              $new_compare_prods_content .= '<div class="float-end pagenav">'.  $Qlisting->getPageSetLinks(CLICSHOPPING::getAllGET(array('page', 'info', 'x', 'y')), 'Shop') .'</div>';
              $new_compare_prods_content .= '<div class="text-end">' . CLICSHOPPING::getDef('text_result_page') .'</div>';
              $new_compare_prods_content .= '</div>';
              $new_compare_prods_content .= '</div>';
              $new_compare_prods_content .= '<div style="padding-top:10px;"></div>';
              $new_compare_prods_content .= '<div class="clearfix"></div>';
            }
          }

          $new_compare_prods_content .= '<div class="separator"></div>';
          $new_compare_prods_content .= '</div>' . "\n";
          $new_compare_prods_content .= '<div class="boxContentsModulesProductsSpecials">';

          if ($listingTotalRow > 0) {

            $new_compare_prods_content .= '<div class="d-flex flex-wrap">';

// display number of short description
            $products_short_description_number = (int)MODULE_PRODUCTS_SPECIAL_COMPARE_SHORT_DESCRIPTION;
// delete words
            $delete_word = (int)MODULE_PRODUCTS_SPECIAL_COMPARE_SHORT_DESCRIPTION_DELETE_WORLDS;
// nbr of column to display  boostrap
            $bootstrap_column = (int)MODULE_PRODUCTS_SPECIAL_COMPARE_COLUMNS;
// initialisation des boutons
            $size_button = $CLICSHOPPING_ProductsCommon->getSizeButton('md');

// Template define
            $filename= '';
            $filename = $CLICSHOPPING_Template-> getTemplateModulesFilename($this->group .'/template_html/' . MODULE_PRODUCTS_SPECIAL_COMPARE_TEMPLATE);
...
//Stock (good, alert, out of stock).
              $products_stock = $CLICSHOPPING_ProductsFunctionTemplate->getStock(MODULE_PRODUCTS_SPECIAL_COMPARE_DISPLAY_STOCK, $products_id);
//Flash discount
...
// Display an input allowing for the customer to insert a quantity
              $input_quantity = $CLICSHOPPING_ProductsFunctionTemplate->getDisplayInputQuantity(MODULE_PRODUCTS_SPECIAL_COMPARE_DELETE_BUY_BUTTON, $products_id);
...
// **************************
              ...
              if (MODULE_PRODUCTS_SPECIAL_COMPARE_DELETE_BUY_BUTTON == 'False') {
...
// See the button more view details
               $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_PRODUCTS_SPECIAL_COMPARE_DELETE_BUY_BUTTON, $products_id);
// Display the image
              $products_image = $CLICSHOPPING_ProductsFunctionTemplate->getImage(MODULE_PRODUCTS_SPECIAL_COMPARE_IMAGE_MEDIUM, $products_id);
// Ticker Image
              $products_image .= $CLICSHOPPING_ProductsFunctionTemplate->getTicker(MODULE_PRODUCTS_SPECIAL_COMPARE_TICKER, $products_id, 'ModulesProductsSpecialsBootstrapTickerSpecial', 'ModulesProductsSpecialsBootstrapTickerFavorites', 'ModulesProductsSpecialsBootstrapTickerFeatured', 'ModulesProductsSpecialsBootstrapTickerNew');

              $ticker = $CLICSHOPPING_ProductsFunctionTemplate->getTickerPourcentage(MODULE_PRODUCTS_SPECIAL_COMPARE_POURCENTAGE_TICKER, $products_id, 'ModulesProductsFeaturedBootstrapTickerPourcentage');
...
// **************************
              ...
              if (is_file($filename)) {
                ob_start();
                require($filename);
                $new_compare_prods_content .= ob_get_clean();
              } else {
            ...
            $new_compare_prods_content .= '</div>';  // flex
// products_compare
            $new_compare_prods_content .= '<div class="col-md-12 stickProductsCompare" id="compare">';
            $new_compare_prods_content .= '<div class="separator"></div>';
            $new_compare_prods_content .= '<div class="text-center">';
            $new_compare_prods_content .= '<button class="btn">';
            $new_compare_prods_content .= HTML::link(CLICSHOPPING::link(null, 'Compare&ProductsCompare'), CLICSHOPPING::getDef('text_products_compare_selected')) . '</button>';
            $new_compare_prods_content .= '</div>';
            $new_compare_prods_content .= '</div>';
          } else {
            $new_compare_prods_content .= '<div class="text-center alert alert-info">'. CLICSHOPPING::getDef('text_no_products') .'</div>';
          }
          ...
          if (($listingTotalRow > 0) && ((PREV_NEXT_BAR_LOCATION == '2') || (PREV_NEXT_BAR_LOCATION == '3'))) {
            if ((PREV_NEXT_BAR_LOCATION == '2') || (PREV_NEXT_BAR_LOCATION == '3')) {
              ...
              $new_compare_prods_content .= '</div>';
              $new_compare_prods_content .= '<div class="col-md-6 float-end">';
              $new_compare_prods_content .= '<span class="float-end pagenav">'.  $Qlisting->getPageSetLinks(CLICSHOPPING::getAllGET(array('page', 'info', 'x', 'y')), 'Shop') .'</span>';
              $new_compare_prods_content .= '<span class="text-end">' . CLICSHOPPING::getDef('text_result_page') .'</span>';
              $new_compare_prods_content .= '</div>';
              $new_compare_prods_content .= '</div>';
              $new_compare_prods_content .= '<div class="clearfix"></div>';
            }
        ...
        $new_compare_prods_content .= '<!--  Products special End -->' . "\n";

        $CLICSHOPPING_Template->addBlock($new_compare_prods_content, $this->group);
    ...
    public function check() {
      return defined('MODULE_PRODUCTS_SPECIAL_COMPARE_STATUS');
    }
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_COMPARE_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_COMPARE_TEMPLATE',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_COMPARE_MAX_DISPLAY',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_COMPARE_COLUMNS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_COMPARE_SHORT_DESCRIPTION',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_COMPARE_SHORT_DESCRIPTION_DELETE_WORLDS',
          'configuration_value' => '0',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_COMPARE_TICKER',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_COMPARE_POURCENTAGE_TICKER',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_COMPARE_DISPLAY_STOCK',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_COMPARE_IMAGE_MEDIUM',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_COMPARE_DELETE_BUY_BUTTON',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SPECIAL_COMPARE_SORT_ORDER',
    ...
    public function keys() {
      return array (
        'MODULE_PRODUCTS_SPECIAL_COMPARE_STATUS',
        'MODULE_PRODUCTS_SPECIAL_COMPARE_TEMPLATE',
        'MODULE_PRODUCTS_SPECIAL_COMPARE_MAX_DISPLAY',
        'MODULE_PRODUCTS_SPECIAL_COMPARE_COLUMNS',
        'MODULE_PRODUCTS_SPECIAL_COMPARE_SHORT_DESCRIPTION',
        'MODULE_PRODUCTS_SPECIAL_COMPARE_SHORT_DESCRIPTION_DELETE_WORLDS',
        'MODULE_PRODUCTS_SPECIAL_COMPARE_TICKER',
        'MODULE_PRODUCTS_SPECIAL_COMPARE_POURCENTAGE_TICKER',
        'MODULE_PRODUCTS_SPECIAL_COMPARE_DISPLAY_STOCK',
        ...
        'MODULE_PRODUCTS_SPECIAL_COMPARE_IMAGE_MEDIUM',
        'MODULE_PRODUCTS_SPECIAL_COMPARE_DELETE_BUY_BUTTON',
        'MODULE_PRODUCTS_SPECIAL_COMPARE_SORT_ORDER'
      );
    }
  }
