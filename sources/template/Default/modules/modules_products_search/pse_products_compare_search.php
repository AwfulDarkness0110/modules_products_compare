 ...
 */
  ...
  class pse_products_compare_search {
    public $code;
    public $group;
    public $title;
    public $description;
    ...
    public function __construct() {
      ...
      $this->title = CLICSHOPPING::getDef('module_products_search_compare_title');
      $this->description = CLICSHOPPING::getDef('module_products_search_compare_description');

      if (defined('MODULE_PRODUCTS_SEARCH_COMPARE_STATUS')) {
        $this->sort_order = MODULE_PRODUCTS_SEARCH_COMPARE_SORT_ORDER;
        $this->enabled = (MODULE_PRODUCTS_SEARCH_COMPARE_STATUS == 'True');
      }
    }
      ...
      $listingTotalRow = $CLICSHOPPING_Search->getResult();
       ...
       if (isset($_GET['Q'])) {
        ...
        if ($max_display != 0 && (isset($_GET['Search']) || isset($_GET['Q']))) {
          ...
          $products_template = MODULE_PRODUCTS_SEARCH_COMPARE_TEMPLATE;
...
// display number of short description
            $products_short_description_number = (int)MODULE_PRODUCTS_SEARCH_COMPARE_SHORT_DESCRIPTION;
// delete words
            $delete_word = (int)MODULE_PRODUCTS_SEARCH_COMPARE_SHORT_DESCRIPTION_DELETE_WORLDS;
// nbr of column to display  boostrap
            $bootstrap_column = (int)MODULE_PRODUCTS_SEARCH_COMPARE_COLUMNS;
// initialisation des boutons
            $size_button = $CLICSHOPPING_ProductsCommon->getSizeButton('md');

// Template define
            $filename = '';
            $filename = $CLICSHOPPING_Template->getTemplateModulesFilename($this->group .'/template_html/' . MODULE_PRODUCTS_SEARCH_COMPARE_TEMPLATE);
...
//Stock (good, alert, out of stock).
              $products_stock = $CLICSHOPPING_ProductsFunctionTemplate->getStock(MODULE_PRODUCTS_SEARCH_COMPARE_DISPLAY_STOCK, $products_id);
//Flash discount
...
// Display an input allowing for the customer to insert a quantity
              $input_quantity = $CLICSHOPPING_ProductsFunctionTemplate->getDisplayInputQuantity(MODULE_PRODUCTS_SEARCH_COMPARE_DELETE_BUY_BUTTON, $products_id);
...
// **************************
              ...
              if (MODULE_PRODUCTS_SEARCH_COMPARE_DELETE_BUY_BUTTON == 'False') {
...
// See the button more view details
              $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_PRODUCTS_SEARCH_COMPARE_DELETE_BUY_BUTTON, $products_id);

// Display the image
              $products_image = $CLICSHOPPING_ProductsFunctionTemplate->getImage(MODULE_PRODUCTS_SEARCH_COMPARE_IMAGE_MEDIUM, $products_id);

// Ticker Image
              $products_image .= $CLICSHOPPING_ProductsFunctionTemplate->getTicker(MODULE_PRODUCTS_SEARCH_COMPARE_TICKER, $products_id, 'ModulesProductsSearchBootstrapTickerSpecial', 'ModulesProductsSearchBootstrapTickerFavorite', 'ModulesProductsSearchBootstrapTickerFeatured', 'ModulesProductsSearchBootstrapTickerNew');

              $ticker = $CLICSHOPPING_ProductsFunctionTemplate->getTickerPourcentage(MODULE_PRODUCTS_SEARCH_COMPARE_POURCENTAGE_TICKER, $products_id, 'ModulesProductsFeaturedBootstrapTickerPourcentage');
...
// products_compare
    ...
    public function check() {
      return defined('MODULE_PRODUCTS_SEARCH_COMPARE_STATUS');
    }
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SEARCH_COMPARE_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SEARCH_COMPARE_TEMPLATE',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SEARCH_COMPARE_COLUMNS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SEARCH_COMPARE_SHORT_DESCRIPTION',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SEARCH_COMPARE_SHORT_DESCRIPTION_DELETE_WORLDS',
          'configuration_value' => '0',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SEARCH_COMPARE_TICKER',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SEARCH_COMPARE_POURCENTAGE_TICKER',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SEARCH_COMPARE_DISPLAY_STOCK',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SEARCH_COMPARE_IMAGE_MEDIUM',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SEARCH_COMPARE_DELETE_BUY_BUTTON',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_SEARCH_COMPARE_SORT_ORDER',
    ...
    public function keys() {
      return array (
        'MODULE_PRODUCTS_SEARCH_COMPARE_STATUS',
        'MODULE_PRODUCTS_SEARCH_COMPARE_TEMPLATE',
        'MODULE_PRODUCTS_SEARCH_MAX_DISPLAY',
        'MODULE_PRODUCTS_SEARCH_COMPARE_COLUMNS',
        'MODULE_PRODUCTS_SEARCH_COMPARE_SHORT_DESCRIPTION',
        'MODULE_PRODUCTS_SEARCH_COMPARE_SHORT_DESCRIPTION_DELETE_WORLDS',
        'MODULE_PRODUCTS_SEARCH_COMPARE_TICKER',
        'MODULE_PRODUCTS_SEARCH_COMPARE_POURCENTAGE_TICKER',
        'MODULE_PRODUCTS_SEARCH_COMPARE_DISPLAY_STOCK',
        ...
        'MODULE_PRODUCTS_SEARCH_COMPARE_IMAGE_MEDIUM',
        'MODULE_PRODUCTS_SEARCH_COMPARE_DELETE_BUY_BUTTON',
        'MODULE_PRODUCTS_SEARCH_COMPARE_SORT_ORDER'
      );
    }
  }
